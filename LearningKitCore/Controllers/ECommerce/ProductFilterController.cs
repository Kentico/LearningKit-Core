...
using LearningKitCore.Models.ECommerce.ProductFilters;
...
namespace LearningKitCore.Controllers.ECommerce
{
    public class ProductFilterController : Controller
    {
        ...
        /// </summary>
        public IActionResult FilterPageProperty()
        {
        ...
        [HttpPost]
        public IActionResult FilterPageProperty(ProductFilterViewModel model)
        {                        
        ...
        /// </summary>
        public IActionResult FilterSKUProperty()
        {
            ProductFilterViewModel model = new ProductFilterViewModel
            {
                FilteredProducts = LoadProducts()
        ...
        /// </summary>
        public IActionResult FilterForeignProperty()
        {
        ...
        [HttpPost]
        public IActionResult FilterForeignProperty(ProductFilterViewModel model)
        {            
            // Creates a view model that consists of all foreign objects (manufacturers) related to the products
