...
namespace LearningKitCore.Controllers.ECommerce
{
    public class OrderController : Controller
    {
        ...
        public IActionResult OrderDetail(string orderId)
        {
            ...
            OrderViewModel order = GetOrderViewModel(orderId);
        ...
        /// <param name="textBoxValue">Order ID as a string</param>
        [HttpPost]
        public IActionResult MarkOrderAsPaid(string orderId)
        {            
            // Gets the order based on the entered order ID
